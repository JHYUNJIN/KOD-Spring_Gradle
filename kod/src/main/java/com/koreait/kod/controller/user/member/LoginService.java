...
//                JsonElement memberIDElement = properties.getAsJsonObject().get("id");
//                if (memberIDElement != null && !memberIDElement.isJsonNull()) {
//                    memberID = memberIDElement.getAsString();
//                }
//                System.out.println("[로그:정현진] memberID : "+memberID);
//                String memberName = null;
//                JsonElement memberNameElement = properties.getAsJsonObject().get("nickname");
//                if (memberNameElement != null && !memberNameElement.isJsonNull()) {
//                    memberName = memberNameElement.getAsString();
//                }
//                System.out.println("[로그:정현진] memberName : "+memberName);
//                String memberEmail = null;
//                JsonObject profileObject = kakao_account.getAsJsonObject("profile");
//                if (profileObject != null) {
//                    JsonElement emailElement = profileObject.get("email");
//                    if (emailElement != null && !emailElement.isJsonNull()) {
//                        memberEmail = emailElement.getAsString();
//                    }
//                }
...
//                String memberEmail = kakao_account.getAsJsonObject().get("memberEmail").getAsString();
                ...
                // MemberDTO 객체에 memberName 값을 설정해줍니다.
