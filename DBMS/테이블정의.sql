...
CREATE TABLE COUPON_STATUS (  
   ...
   FOREIGN KEY (COUPON_ID) REFERENCES COUPON(COUPON_ID) ON DELETE CASCADE,
   ORDERCONTENT_ID INT,
   FOREIGN KEY (ORDERCONTENT_ID) REFERENCES ORDERCONTENT(ORDERCONTENT_ID) ON DELETE CASCADE
);
...
ADD COLUMN ORDERCONTENT_ID INT,
ADD CONSTRAINT fk_order
    FOREIGN KEY (ORDERCONTENT_ID)
    REFERENCES ORDERCONTENT(ORDERCONTENT_ID);
